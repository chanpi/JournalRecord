========================================================================
 ダイナミック リンク ライブラリ: JournalRecord プロジェクトの概要
========================================================================

この JournalRecord DLL は、AppWizard により作成されました。

このファイルには、JournalRecord 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


JournalRecord.vcxproj
