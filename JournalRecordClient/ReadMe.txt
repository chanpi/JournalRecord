========================================================================
    Win32 アプリケーション: JournalRecordClient プロジェクトの概要
========================================================================

この JournalRecordClient アプリケーションは、AppWizard により作成されました。

このファイルには、JournalRecordClient 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


JournalRecordClient.vcxproj
...
JournalRecordClient.vcxproj.filters
...
JournalRecordClient.ico
    これは、アプリケーションのアイコン (32x32) として使用されるアイコン 
    ファイルです。
    このアイコンは、メイン リソース ファイル JournalRecordClient.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル JournalRecordClient.rc 
    にインクルードされます。
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、JournalRecordClient.pch 
